...
class Game {
  ...
  constructor() {
    ...
    ctx!.fillStyle = "black";
      const gameOverlayWidth = 100;
      const gameOverlayHeight = 50;
    ctx!.strokeRect((canvas.width - gameOverlayWidth)/ 2, (canvas.height - gameOverlayHeight)/2 , gameOverlayWidth, 50);
    gameOver = true;
  };
